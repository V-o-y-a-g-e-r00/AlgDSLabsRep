...
#Этот способ рабочий. Потом нужно преобразовать к .PNG с помощью команды. and then use imagemagick to convert the vector format to a .png: convert -verbose -density 150 -trim file.pdf -quality 100 -flatten -sharpen 0x1.0 file.png
